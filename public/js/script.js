...
dropdowns.forEach((dropdown) => {
  ...
  dropdown.addEventListener("click", (e) => {
    ...
    for (const el of dropdowns) {
      //console.log(el, e.target.parentElement);
      if (el !== e.target.parentElement && el.nextElementSibling.classList.contains("menu-show")) {
        // Toggle dropdown menu show class
        el.nextElementSibling.classList.toggle("menu-show");
        // Toggle icon rotated class
        el.lastElementChild.classList.toggle("icon-rotated");
      }
    }
...
subDropdowns.forEach((subDropdown) => {
  ...
  subDropdown.addEventListener("click", (e) => {
    // Close Siblings
    for (const el of subDropdowns) {
      //console.log(el, e.target.parentElement);
      if (
        el !== e.target.parentElement &&
        el.nextElementSibling.classList.contains("sub-menu-show")
      ) {
        // Toggle dropdown menu show class
        el.nextElementSibling.classList.toggle("sub-menu-show");
        // Toggle icon rotated class
        el.lastElementChild.classList.toggle("icon-rotated");
      }
    }
